...
config = YAML.load_file("src/structural_model_heterogenous_preferences/local_objective_search/test_neldermeand_config_3.yaml")
...
YAML.write_file("src/structural_model_heterogenous_preferences/local_objective_search/test_neldermeand_config_3.yaml", config)
